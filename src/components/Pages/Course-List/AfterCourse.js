...
import Loader from '../../Loader/loader'
    ...
    const [onLineCourse,setOnlineCourse] = useState([]);
	    ...
	    const getResult = async() =>{
            ...
            setResult(data)
			  await
			  fetch(`https://api.odmit.com/api/v1/institute-stack?qualification=${selectQualification}&stream=${selectStream}&substream=${selectSubStream}&course_type=${courseType}&country=${selectCountry}&category=${selectCategory}&page=1&limit=6&offset=0`)
			   .then((response)=>{
        ...
        const getResultPageSecond = async() =>{
                ...
                await fetch(`https://api.odmit.com/api/v1/institute-stack?qualification=${selectQualification}&stream=${selectStream}&substream=${selectSubStream}&course_type=${courseType}&country=${selectCountry}&category=${selectCategory}&page=2&limit=6&offset=0`)
                       .then((response)=>{
                           return response.json()
                       })
                       .then((res)=>{
                        //    console.log(res.response.data,"nexxxtttt page")
                           setPageSecond(res.response.data)
                       })
                       .catch((err)=>{
                           console.log(err)
                       })
